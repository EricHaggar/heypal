        ...
        <div className='body'>
          <div className='intro-container'>
            <div className='intro-text'>
              ...
              The average will also be shown and analyzed based on the following seniment score range: <br /><br />
              <center>
                <img src={scores} alt="image" height="45" />
              </center>
              <br />
              <br />
              <h4>Technology Stack: <img src={reactNode} alt="image" height="45" /></h4>
              <h4>Github Repo: <a href="https://github.com/EricHaggar/HeyPal" target="_blank"><img src={githubIcon} height="45" alt="image" /></a></h4>
            </div>
          </div>
